...
Tronloop, pilleri senaryolara göre şarj/deşarj eder ve verileri bulutta saklar. Sisteme bağlanan cluster'ların içinde Vertex test node'ları bulunur. Linux sunucusu ClusterPilot, Vertex verilerini buluttaki MQTT'ye gönderir. Gönderemediği verileri yerel SQLite'ta biriktirir ve sonradan gönderir.
